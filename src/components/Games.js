...
const Games = ({ history }) => {
  ...
  return (
    <div className="games">
      <Link className="games__return" to="/navigate">
      ...
      <div className="games__content">
        <a href="nytxwd://" className="games__game games__game--crossword">
          <img
            src={crosswordIcon}
            alt="Crossword Icon"
            className="games__icon crossword"
          />
          Crossword
        </a>
        <a
          href="fb352087441476409://"
          className="games__game games__game--sudoku"
        >
          <img
            src={sudokuIcon}
            alt="Sudoku Icon"
            className="games__icon sudoku"
          />
          Sudoku
        </a>
        <a
          href="fb201726756564188://"
          className="games__game games__game--tetris"
        >
          <img
            src={tetrisIcon}
            alt="Tetris Icon"
            className="games__icon tetris"
          />
          Tetris
        </a>
      </div>
